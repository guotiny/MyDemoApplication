package com.guotiny.mydemoapplication.magicviewpagerindicator;
...
import com.guotiny.mydemoapplication.magicviewpagerindicator.ext.titles.ScaleTransitionPagerTitleView;
...
/***
 * 博客地址：http://www.jianshu.com/p/2865812fed41
 * github地址:  https://github.com/hackware1993/MagicIndicator
 */
public class IndicatiorMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_indicatior_main);
        ...
        commonNavigator12.setAdapter(new CommonNavigatorAdapter() {
            ...
            @Override
            public IPagerTitleView getTitleView(Context context, final int index) {
                CommonPagerTitleView commonPagerTitleView = new CommonPagerTitleView(IndicatiorMainActivity.this);
