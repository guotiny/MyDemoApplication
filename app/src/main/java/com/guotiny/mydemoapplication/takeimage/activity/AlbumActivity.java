...
import com.guotiny.mydemoapplication.takeimage.adapter.AlbumGridViewAdapter;
import com.guotiny.mydemoapplication.takeimage.util.AlbumHelper;
import com.guotiny.mydemoapplication.takeimage.util.Bimp;
import com.guotiny.mydemoapplication.takeimage.util.ImageBucket;
...
public class AlbumActivity extends Activity {
	...
	private class AlbumSendListener implements OnClickListener {
		public void onClick(View v) {
			...
			intent.setClass(mContext, TakeImagesMainActivity.class);
			startActivity(intent);
			finish();
		}
